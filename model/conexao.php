<?php
    ...
    $banco_de_dados = 'mysql:host=localhost;dbname=e-commerce';
    // Indicando qual é o usuário que terá acesso
    $user = 'root';
    // Passando a senha do banco.
    $password='';
    // Para tratar os erros, caso aconteça, usaremos o try..catch que é usado na linguagem.
    try{
        // Primeiro criamos a conexão passando qual sintax iremos usar, o banco, o nome e a senha de usuário.
